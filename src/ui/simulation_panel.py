...
class SimulationPanel(QWidget):
    ...
    def setup_ui(self):
        ...
        # Interaction neighborhood cutoff radius
        lbl_irad = QLabel("Interaction radius:")
        #lbl_tol.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        self.irad_spin = QDoubleSpinBox()
        self.t1_spin.setRange(0.001, 1e6)
        self.t1_spin.setDecimals(3)
        self.t1_spin.setSingleStep(0.5)
        self.irad_spin.setValue(5.0)
        ...
        solver_grid.addWidget(lbl_irad, 0, 0)
        solver_grid.addWidget(self.irad_spin, 0, 1)
    ...
    def get_simulation_data(self):
        ...
        return {
            ...
            "options": {
                "irad": clean_float(self.irad_spin.value())
            }
        }


class SimulationPanel_ode45(QWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setup_ui()
